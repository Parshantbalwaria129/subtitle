<template>
    <div class="subtitle-item-container" :class="{ focus: isFocused }" :onFocusin="setFocusIn" :onFocusout="setFocusOut">
        ...
        <div class="subtitle-button-container">
            ...
            <svg @click="deleteCard" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <svg @click="addCard" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
